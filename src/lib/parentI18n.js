...
const P = {
  ...
  ts_bonus_amount:   { en: '+%n% gems once a day', tr: 'günde bir kez +%n% gem', es: '+%n% gems una vez al día' },
  ts_bonus_title:    { en: 'All-Rounder of the Day', tr: 'Günün Hezarfeni', es: 'Todoterreno del día' },
  ts_bonus_sub:      { en: 'A bonus once a day for doing maths, reading, a story, a drawing and puzzles — all of them. Homework and the tree do not count.',
                       tr: 'Matematik, okuma, hikâye, çizim ve bulmacanın hepsini aynı gün yapınca günde bir kez bonus. Ödev ve ağaç sayılmaz.',
                       es: 'Un bonus una vez al día por hacer mates, lectura, un cuento, un dibujo y acertijos, todo. Los deberes y el árbol no cuentan.' },
  ts_bonus_young:    { en: 'For ages 7 and up — %name% will get it from their 7th birthday.', tr: '7 yaş ve üstü için — %name% 7 yaşına girince başlar.',
                       es: 'Para 7 años o más: %name% lo tendrá desde que cumpla 7.' },
  ...
  db_birth_date:     { en: 'Birth date', tr: 'Doğum tarihi', es: 'Fecha de nacimiento' },
  db_birth_hint:     { en: 'Their age updates itself every birthday.', tr: 'Yaşı her doğum gününde kendiliğinden güncellenir.',
                       es: 'Su edad se actualiza sola en cada cumpleaños.' },
  db_err_birth:      { en: 'Pick their birth date.', tr: 'Doğum tarihini seç.', es: 'Elige su fecha de nacimiento.' },
  cd_birthday_title: { en: "Add %name%'s birthday", tr: '%name% için doğum tarihi ekle', es: 'Añade el cumpleaños de %name%' },
  cd_birthday_sub:   { en: 'Then their age, and the maths and puzzles that go with it, move up by themselves each year.',
                       tr: 'Böylece yaşı, ona göre gelen matematik ve bulmacalar her yıl kendiliğinden bir üst seviyeye geçer.',
                       es: 'Así su edad, y las mates y los acertijos que van con ella, suben solos cada año.' },
