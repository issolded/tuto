...
const P = {
  // Screen controls: parent settings and parent-operated web preview.
  sc_title: {en: "Screen Control", tr: "Ekran Kontrolü", es: "Control de pantalla"},
  sc_intro: {en: "Daily limits, routines and Gem rewards", tr: "Günlük limitler, programlar ve Gem ödülleri", es: "Límites diarios, rutinas y premios con Gems"},
  sc_demo: {en: "Web demo · Android controls not connected", tr: "Web denemesi · Android kontrolü bağlı değil", es: "Demo web · Controles de Android sin conectar"},
  sc_notice: {en: "Try the rules with sample apps and 100 demo Gems. This page cannot measure or block other apps. Real Gems are never spent.", tr: "Kuralları örnek uygulamalar ve 100 deneme Gem’i ile dene. Bu sayfa diğer uygulamaları ölçemez veya engelleyemez. Gerçek Gem harcanmaz.", es: "Prueba las reglas con apps de ejemplo y 100 Gems de prueba. Esta página no mide ni bloquea otras apps. No se gastan Gems reales."},
  sc_child: {en: "Child", tr: "Çocuk", es: "Niño"},
  sc_no_child: {en: "Add a child from your dashboard first.", tr: "Önce panodan bir çocuk ekle.", es: "Añade primero un niño desde el panel."},
  sc_load_error: {en: "Could not load settings. Try again.", tr: "Ayarlar yüklenemedi. Tekrar dene.", es: "No se han podido cargar los ajustes. Inténtalo otra vez."},
  sc_retry: {en: "Try again", tr: "Tekrar dene", es: "Reintentar"},
  sc_rules: {en: "Rules", tr: "Kurallar", es: "Reglas"},
  sc_preview: {en: "Try child view", tr: "Çocuk görünümünü dene", es: "Probar vista infantil"},
  sc_limits: {en: "Daily play budget", tr: "Günlük oyun bütçesi", es: "Tiempo de juego diario"},
  sc_weekday: {en: "Weekdays · minutes", tr: "Hafta içi · dakika", es: "Entre semana · minutos"},
  sc_weekend: {en: "Weekends · minutes", tr: "Hafta sonu · dakika", es: "Fin de semana · minutos"},
  sc_cap: {en: "Daily maximum, including rewards · minutes", tr: "Ödüller dahil günlük tavan · dakika", es: "Máximo diario, incluidos premios · minutos"},
  sc_rewards: {en: "Earn more play time", tr: "Ek oyun süresi kazanma", es: "Ganar más tiempo"},
  sc_rate: {en: "Gems for 1 minute", tr: "1 dakika için Gem", es: "Gems por 1 minuto"},
  sc_earned_cap: {en: "Maximum earned time per day · minutes", tr: "Günlük kazanılabilecek ek süre · dakika", es: "Tiempo ganado máximo al día · minutos"},
  sc_approval: {en: "Ask a parent before spending Gems", tr: "Gem harcamadan önce ebeveyne sor", es: "Pedir permiso antes de gastar Gems"},
  sc_schedules: {en: "Protected hours", tr: "Korunan saatler", es: "Horas protegidas"},
  sc_bedtime: {en: "Bedtime · every day", tr: "Uyku saati · her gün", es: "Hora de dormir · cada día"},
  sc_school: {en: "School · weekdays", tr: "Okul · hafta içi", es: "Colegio · entre semana"},
  sc_start: {en: "Start", tr: "Başlangıç", es: "Inicio"},
  sc_end: {en: "End", tr: "Bitiş", es: "Fin"},
  sc_timezone: {en: "Times use this device’s time zone: %zone%. Rewards do not override protected hours.", tr: "Saatler bu cihazın saat dilimini kullanır: %zone%. Ödüller korunan saatleri açmaz.", es: "Se usa la zona horaria de este dispositivo: %zone%. Los premios no anulan las horas protegidas."},
  sc_apps: {en: "Example apps", tr: "Örnek uygulamalar", es: "Apps de ejemplo"},
  sc_apps_note: {en: "These are demo choices, not apps detected on your device. Tuto stays available.", tr: "Bunlar deneme seçenekleri; cihazından tespit edilen uygulamalar değil. Tuto açık kalır.", es: "Son opciones de prueba, no apps detectadas en el dispositivo. Tuto sigue disponible."},
  sc_timed: {en: "Use play budget", tr: "Oyun bütçesini kullan", es: "Usar tiempo de juego"},
  sc_allowed: {en: "Always allowed", tr: "Her zaman izinli", es: "Siempre permitida"},
  sc_blocked: {en: "Blocked", tr: "Engelli", es: "Bloqueada"},
  sc_saved: {en: "Rules saved to your account. No device controls are active.", tr: "Kurallar hesabına kaydedildi. Cihaz kontrolü aktif değil.", es: "Reglas guardadas en tu cuenta. Los controles del dispositivo no están activos."},
  sc_save_error: {en: "Could not save. Your changes are still here; try again.", tr: "Kaydedilemedi. Değişikliklerin burada duruyor; tekrar dene.", es: "No se ha podido guardar. Tus cambios siguen aquí; inténtalo otra vez."},
  sc_invalid: {en: "Use whole numbers. Maximum must cover both daily budgets and earned time. Enabled schedules need different start and end times.", tr: "Tam sayı kullan. Günlük tavan, iki günlük bütçeyi ve ek süre sınırını kapsamalı. Açık programların başlangıcı ve bitişi farklı olmalı.", es: "Usa números enteros. El máximo debe cubrir ambos presupuestos y el límite ganado. Los horarios activos necesitan inicio y fin distintos."},
  sc_unsaved: {en: "Unsaved rules · preview uses these changes", tr: "Kaydedilmemiş kurallar · deneme bu değişiklikleri kullanır", es: "Reglas sin guardar · la prueba usa estos cambios"},
  sc_demo_child: {en: "Child preview", tr: "Çocuk önizlemesi", es: "Vista infantil"},
  ...
  sc_used: {en: "Used: %n% min · earned: %earned% min", tr: "Kullanılan: %n% dk · kazanılan: %earned% dk", es: "Usado: %n% min · ganado: %earned% min"},
  sc_play: {en: "Start demo", tr: "Denemeyi başlat", es: "Iniciar prueba"},
  sc_stop: {en: "Stop demo", tr: "Denemeyi durdur", es: "Detener prueba"},
  sc_advance: {en: "Simulate 1 minute", tr: "1 dakika kullanım dene", es: "Simular 1 minuto"},
  ...
  sc_parent_actions: {en: "Parent demo controls", tr: "Ebeveyn deneme kontrolleri", es: "Controles parentales de prueba"},
  sc_pause: {en: "Pause play", tr: "Oyunları duraklat", es: "Pausar juegos"},
  sc_resume: {en: "Resume play", tr: "Oyunlara devam et", es: "Reanudar juegos"},
  sc_add: {en: "Add up to 10 min", tr: "En fazla 10 dk ekle", es: "Añadir hasta 10 min"},
  sc_pending: {en: "5 minutes requested · %n% demo Gems. Approve or decline below.", tr: "5 dakika istendi · %n% deneme Gem’i. Aşağıdan onayla veya reddet.", es: "Se han pedido 5 minutos · %n% Gems de prueba. Aprueba o rechaza abajo."},
  sc_approve: {en: "Approve", tr: "Onayla", es: "Aprobar"},
  sc_reject: {en: "Decline", tr: "Reddet", es: "Rechazar"},
  sc_clock: {en: "Demo date & time · changing it resets the demo", tr: "Deneme tarihi ve saati · değiştirmek denemeyi sıfırlar", es: "Fecha y hora de prueba · cambiarlas reinicia la prueba"},
  sc_reset: {en: "Reset demo", tr: "Denemeyi sıfırla", es: "Reiniciar prueba"},
  sc_session: {en: "Demo activity is shared with the child view in this browser only. It does not sync across devices. The timer pauses when the demo is closed or hidden.", tr: "Deneme etkinliği yalnızca bu tarayıcıdaki çocuk görünümüyle paylaşılır; cihazlar arasında aktarılmaz. Deneme kapatılınca veya gizlenince sayaç durur.", es: "La prueba se comparte con la vista infantil solo en este navegador, no entre dispositivos. El reloj se pausa al cerrar u ocultar la prueba."},
  sc_history: {en: "Demo activity", tr: "Deneme geçmişi", es: "Actividad de prueba"},
  sc_history_empty: {en: "Your demo actions will appear here.", tr: "Deneme işlemlerin burada görünecek.", es: "Tus acciones de prueba aparecerán aquí."},
  ...
  sc_event_paused: {en: "Play paused", tr: "Oyunlar duraklatıldı", es: "Juegos pausados"},
  sc_event_resumed: {en: "Play resumed", tr: "Oyunlar devam ediyor", es: "Juegos reanudados"},
  sc_event_bonus: {en: "Parent added %n% min", tr: "Ebeveyn %n% dk ekledi", es: "Tu familia añadió %n% min"},
  sc_event_redeemed: {en: "Exchanged demo Gems for %n% min", tr: "Deneme Gem’i ile %n% dk alındı", es: "Gems de prueba cambiadas por %n% min"},
  sc_event_requested: {en: "Requested %n% min", tr: "%n% dk istendi", es: "Se pidieron %n% min"},
  sc_event_approved: {en: "Approved %n% min", tr: "%n% dk onaylandı", es: "Se aprobaron %n% min"},
  sc_event_rejected: {en: "Request declined · no Gems spent", tr: "Talep reddedildi · Gem harcanmadı", es: "Petición rechazada · sin gastar Gems"},
  ...
  db_settings:       { en: 'Settings', tr: 'Ayarlar', es: 'Ajustes' },
  db_pending_n:      { en: '%n% waiting for you', tr: '%n% onay bekliyor', es: '%n% esperan tu OK' },
  db_today_none:     { en: 'Nothing yet today', tr: 'Bugün henüz bir şey yok', es: 'Hoy todavía nada' },
  db_today_label:    { en: 'Today', tr: 'Bugün', es: 'Hoy' },
  db_reach:          { en: 'How Tuto reaches you', tr: 'Tuto sana nasıl ulaşır', es: 'Cómo te escribe Tuto' },
  db_when:           { en: 'When I write', tr: 'Ne zaman yazarım', es: 'Cuándo te escribo' },
  db_connect_reminder: { en: 'Connect Telegram or WhatsApp so Tuto can write to you.', tr: "Tuto'nun sana yazabilmesi için Telegram ya da WhatsApp'ı bağla.",
                       es: 'Conecta Telegram o WhatsApp para que Tuto pueda escribirte.' },
