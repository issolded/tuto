...
const STRINGS = {
  ...
  rd_been_reading:    { en: 'I read some pages 📸', tr: 'Birkaç sayfa okudum 📸' },
  rd_set_page:        { en: 'Which page are you on? 📖', tr: 'Kaçıncı sayfadasın? 📖' },
  rd_cancel:          { en: 'Cancel', tr: 'Vazgeç' },
  rd_finished_book:   { en: 'I finished this book! 🏆', tr: 'Bu kitabı bitirdim! 🏆' },
  ...
  rd_finish_yes:      { en: 'Yes, I finished it! 🏆', tr: 'Evet, bitirdim! 🏆' },
  rd_finish_no:       { en: 'Not yet, I am still reading', tr: 'Daha bitmedi, okumaya devam' },
  rd_last_page:       { en: 'You stopped on page %n% 📖', tr: '%n%. sayfaya kadar okumuştun 📖' },
  ...
  puzzle_enc_high:    { en: 'You read those shapes really carefully! 🌟',
                        tr: 'Şekilleri çok dikkatli okudun! 🌟' },
  puzzle_enc_mid:     { en: 'Nice work! You spot more every time 💪',
                        tr: 'Güzel iş! Her seferinde daha çok şey görüyorsun 💪' },
  puzzle_enc_low:     { en: 'Those were tricky ones — keep at it, they get easier 🌱',
                        tr: 'Bunlar zorlu bulmacalardı — devam et, gittikçe kolaylaşacak 🌱' },
