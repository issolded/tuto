...
const STRINGS = {
  ...
  score_mid_young:    { en: "Great job! You did really well! ⭐ Let's keep practicing!", tr: 'Aferin! Gerçekten iyi yaptın! ⭐ Hadi çalışmaya devam!' },
  ...
  score_low_mid:      { en: "You gave it your best! 💪 Every practice makes you better!", tr: 'Elinden geleni yaptın! 💪 Her çalışma seni daha iyi yapıyor!' },
  ...
  score_vlow_mid:     { en: "These were tough! You'll get there with practice! 💪", tr: 'Bunlar zordu! Çalışınca gelecek! 💪' },
