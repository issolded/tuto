...
// `soft tapping → easy`. Only the substitutions read aloud and accepted here may be answers.
// The key is the exact WordNet example sentence; the values are the exact replaceable forms.
export const SENSE_ANSWERS = {
  'the train moved ahead slowly': ['forward', 'forwards', 'onward', 'onwards'],
  'as he waited he could feel the air on his neck': ['breeze'],
  'he felt bad about breaking the vase': ['sorry'],
  'a ball of mud caught him on the shoulder': ['chunk', 'lump'],
  'he got a bang on the head': ['knock'],
  'the base of the lamp': ['pedestal', 'stand'],
  'he could feel the beat of her heart': ['pulse'],
  'the conductor set the beat': ['rhythm'],
  'a bend in the road': ['turn', 'twist'],
  'a bend of his elbow': ['crease', 'fold'],
  "let's break for lunch": ['pause'],
  'the break seems to have been caused by a fall': ['fracture'],
  'the catch was only 10 fish': ['haul'],
  'my only choice is to refuse': ['alternative', 'option'],
  'I always choose the fish over the meat courses in this restaurant': ['prefer'],
  'the smaller component is hard to reach': ['part', 'portion'],
  'put the cover back on the kettle': ['top'],
  'a mule is a cross between a horse and a donkey': ['hybrid'],
  "a baby's delicate skin": ['soft'],
  'a kite too delicate to fly safely': ['fragile'],
  'put his dirty feet on the clean sheet': ['soiled', 'unclean'],
  'he took the family for a drive in his new car': ['ride'],
  'the Earth moves around the sun': ['globe', 'world'],
  'George Washington is the father of his country': ['founder'],
  'dinner and the movies had been fine': ['okay'],
  "fire was one of our ancestors' first discoveries": ['flame'],
  'fix breakfast for the guests, please': ['prepare'],
  'he admired the gold of her hair': ['amber'],
  'why is it so hard for you to keep a secret?': ['difficult'],
  'they ran forward into the heart of the struggle': ['center', 'centre', 'middle'],
  "she's the very image of her mother": ['double'],
  'a big (or large) barn': ['big'],
  'he complained about the length of time required': ['duration'],
  'he determined the length of the shortest line segment joining the two points': ['distance'],
  "that's a load off my mind": ['burden'],
  'cows in India are running loose': ['free'],
  "the old man's skin hung loose and grey": ['slack'],
  "I'll mail you the paper when it's written": ['send'],
  'let them match their best athletes against ours': ['oppose'],
  'he had a good memory when he was younger': ['retention'],
  'at the peak of the pyramid': ['apex', 'vertex'],
  'the view from the peak was magnificent': ['top'],
  'a piece of pie': ['slice'],
  'he needed a piece of granite': ['part'],
  'a plan for seating guests': ['design'],
  'a point of information': ['detail', 'item'],
  'the push of the water on the walls of the tank': ['thrust'],
  'the quiet waters of a lagoon': ['still'],
  'the plains lay just beyond the mountain range': ['chain'],
  'This car can reach a speed of 140 miles per hour': ['attain'],
  'it was hidden in the rear of the store': ['back'],
  'can you remember her phone number?': ['recall'],
  'there was a rip in his pants': ['tear'],
  'a screen of trees afforded privacy': ['cover'],
  'finished the final segment of the road': ['section'],
  'the clock is almost an hour slow': ['behind'],
  'a soft (or light) tapping at the window': ['gentle'],
  'he said the space is the most important character in the alphabet': ['blank'],
  'it came to a stop at the bottom of the hill': ['halt'],
  'stretch out that piece of cloth': ['extend'],
  'a string of beads': ['chain', 'strand'],
  'wheat is the stuff they use to make bread': ['material'],
  'he borrowed a large sum': ['amount'],
  'The teams drew a tie': ['draw'],
  'she likes the touch of silk on her skin': ['feeling'],
  'this dish could use a touch of garlic': ['hint'],
  'he speaks French with a trace of an accent': ['hint', 'suggestion'],
  'they joined the wagon train for safety': ['caravan'],
  'This book upset me': ['disturb'],
  'the kids played their music at full volume': ['intensity'],
  'the report in the paper is wrong': ['incorrect'],
}
