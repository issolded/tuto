  ...
  return (
    <div onClick={e => { e.stopPropagation(); !deleting && onCancel() }} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.45)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: 28 }}>
      <div onClick={e => e.stopPropagation()} style={{ background: 'white', borderRadius: 28, padding: '32px 24px 24px', width: '100%', maxWidth: 320, boxShadow: '0 24px 64px rgba(0,0,0,0.22)', textAlign: 'center' }}>
        ...
        <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 20, fontWeight: 800, color: '#2D5016', marginBottom: 8 }}>Delete this story?</div>
        <div style={{ fontSize: 14, color: '#6A9956', fontWeight: 600, marginBottom: 28, lineHeight: 1.5 }}>This can't be undone.</div>
        <div style={{ display: 'flex', gap: 10 }}>
          <button onClick={onCancel} disabled={deleting} style={{ flex: 1, padding: '14px', border: 'none', borderRadius: 14, background: '#F0FFF4', color: '#2D5016', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 16, fontWeight: 800, cursor: 'pointer' }}>Cancel</button>
          <button onClick={onConfirm} disabled={deleting} style={{ flex: 1, padding: '14px', border: 'none', borderRadius: 14, background: '#FF3B30', color: 'white', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 16, fontWeight: 800, cursor: 'pointer', boxShadow: '0 4px 14px rgba(255,59,48,0.35)', opacity: deleting ? 0.6 : 1 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 28px 48px', gap: 0 }}>
          ...
          {titleSuggestion ? (
            ...
            <button
              ...
              style={{ width: '100%', marginTop: 16, background: '#2EC486', border: 'none', borderRadius: 18, padding: '16px', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 18, fontWeight: 800, color: 'white', cursor: storyTitle.trim() && !checkingTitle ? 'pointer' : 'default', opacity: storyTitle.trim() && !checkingTitle ? 1 : 0.4, boxShadow: '0 4px 16px rgba(46,196,134,0.30)', animation: 'fadeUp 0.4s ease 0.2s both' }}
            >
    ...
    return (
      <div style={{ background: BG, minHeight: '100vh', maxWidth: isTablet ? 1180 : 430, margin: '0 auto', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 28px 48px', gap: 0 }}>
          ...
          <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 20, fontWeight: 800, color: '#2D5016', textAlign: 'center', marginTop: 14, marginBottom: 24, lineHeight: 1.3, animation: 'fadeUp 0.35s ease 0.08s both' }}>
            {displayTitle}
          </div>
          ...
          {photos.length > 0 && (
            <button
              ...
              style={{ width: '100%', background: '#2EC486', border: 'none', borderRadius: 20, padding: '18px', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 19, fontWeight: 800, color: 'white', cursor: 'pointer', boxShadow: '0 4px 16px rgba(46,196,134,0.35)', animation: 'fadeUp 0.25s ease both' }}
            >
              I'm done! 🎉
            </button>
          )}
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 28px 48px' }}>
          ...
          <div style={{ background: 'white', borderRadius: 28, padding: '28px 24px', width: '100%', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', textAlign: 'center', marginTop: 24, boxSizing: 'border-box', animation: 'fadeUp 0.4s ease 0.1s both' }}>
            {evalResult?.has_profanity ? (
              <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 18, fontWeight: 800, color: '#2D5016', lineHeight: 1.7 }}>
              ...
              <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 20, fontWeight: 800, color: '#2D5016', lineHeight: 1.7 }}>
          ...
          {isBlocked ? (
            ...
            <button
              ...
              style={{ width: '100%', marginTop: 24, background: '#4cb685', border: 'none', borderRadius: 20, padding: '18px', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 17, fontWeight: 800, color: 'white', cursor: 'pointer', boxShadow: '0 4px 16px rgba(76,182,133,0.35)', animation: 'fadeUp 0.4s ease 0.2s both' }}
            >
        ...
        <div style={{ flex: 1, padding: '0 24px 48px' }}>
          {isEditMode ? (
            <input
              ...
              style={{ width: '100%', boxSizing: 'border-box', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 18, fontWeight: 800, color: '#2D5016', marginBottom: 8, border: '2px solid #A5D6A7', borderRadius: 14, padding: '8px 12px', background: 'white', outline: 'none', animation: 'fadeUp 0.35s ease both' }}
            />
          ) : (
        ...
        {activeError !== null && errors[activeError] && (
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(45,80,22,0.4)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', zIndex: 100 }} onClick={() => setActiveError(null)}>
            <div style={{ background: 'white', width: '100%', maxWidth: 430, borderRadius: '28px 28px 0 0', padding: '28px 24px 44px', animation: 'fadeUp 0.25s ease both' }} onClick={e => e.stopPropagation()}>
              ...
              <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 18, fontWeight: 800, color: '#2D5016', textAlign: 'center', marginBottom: 20 }}>
        ...
        <div style={{ flex: 1, padding: '0 24px 48px' }}>
          {isEditMode ? (
            <input
              ...
              onChange={e => setStoryTitle(e.target.value)}
              placeholder={displayTitle}
              style={{ width: '100%', boxSizing: 'border-box', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 22, fontWeight: 800, color: '#2D5016', marginBottom: 16, border: '2px solid #A5D6A7', borderRadius: 14, padding: '8px 12px', background: 'white', outline: 'none', animation: 'fadeUp 0.35s ease both' }}
            />
          ) : (
            <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 22, fontWeight: 800, color: '#2D5016', marginBottom: 16, animation: 'fadeUp 0.35s ease both' }}>
              {displayTitle}
            </div>
          )}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, animation: 'fadeUp 0.35s ease 0.16s both' }}>
            <button onClick={() => finishStory('completed')} style={{ background: '#2EC486', border: 'none', borderRadius: 20, padding: '18px', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 17, fontWeight: 800, color: 'white', cursor: 'pointer', boxShadow: '0 4px 16px rgba(46,196,134,0.35)' }}>
      ...
      <div style={{ background: BG_YOUNG, minHeight: '100vh', maxWidth: isTablet ? 1180 : 430, margin: '0 auto', display: 'flex', flexDirection: 'column' }}>
        ...
        {activeError !== null && youngErrors[activeError] && (
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(47,158,107,0.35)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', zIndex: 100 }} onClick={() => setActiveError(null)}>
            <div style={{ background: 'white', width: '100%', maxWidth: 430, borderRadius: '28px 28px 0 0', padding: '28px 24px 44px', animation: 'fadeUp 0.25s ease both' }} onClick={e => e.stopPropagation()}>
              <div style={{ width: 36, height: 4, background: '#E8E8F0', borderRadius: 4, margin: '0 auto 20px' }} />
              <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 18, fontWeight: 800, color: '#2f9e6b', textAlign: 'center', marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                <button
                  onClick={() => { setSpellingState(prev => prev.map((s, i) => i === activeError ? 'fixed' : s)); setActiveError(null) }}
                  style={{ flex: 1, background: '#4cb685', border: 'none', borderRadius: 16, padding: '14px', fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 15, fontWeight: 800, color: 'white', cursor: 'pointer' }}
                >
                  ✅ Yes!
                </button>
                <button
    ...
    return (
      <div style={{ background: BG, minHeight: '100vh', maxWidth: isTablet ? 1180 : 430, margin: '0 auto', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: coverReturnStep ? '12px 24px 16px' : '52px 24px 16px', textAlign: 'center' }}>
          <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 24, fontWeight: 800, color: '#2D5016' }}>Design your cover! 🎨</div>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 28px 48px', gap: 20 }}>
          ...
          >
            ...
            <div style={{ padding: '14px 14px 8px 18px', flexShrink: 0, zIndex: 2 }}>
              <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 13, fontWeight: 800, color: '#1A2E0A', textAlign: 'center', lineHeight: 1.25 }}>
                {displayTitle}
              </div>
            </div>
  ...
  if (step === 'done') {
    ...
    return (
      <div style={{ background: isYoung ? BG_YOUNG : BG, minHeight: '100vh', maxWidth: isTablet ? 1180 : 430, margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 28px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ fontFamily: "'TrRound', 'Baloo 2', cursive", fontSize: 34, fontWeight: 900, color: isYoung ? '#2f9e6b' : '#2D5016', marginTop: 20, textAlign: 'center', lineHeight: 1.2, animation: 'fadeUp 0.4s ease 0.1s both' }}>
        ...
        <div style={{ background: 'white', borderRadius: isYoung ? 36 : 28, padding: '24px 44px', marginTop: 20, boxShadow: '0 8px 32px rgba(76,182,133,0.20)', animation: 'fadeUp 0.4s ease 0.15s both', textAlign: 'center' }}>
          <div style={{ fontSize: 56, fontWeight: 900, fontFamily: "'TrRound', 'Baloo 2', cursive", color: '#f79433', lineHeight: 1 }}>
            +{gems}
          </div>
